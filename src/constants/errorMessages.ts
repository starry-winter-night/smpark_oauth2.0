export const ERROR_MESSAGES = {
  ...
  SCOPE_CONSENT: {
    UPDATE_FAILURE:
      'scope 동의여부를 업데이트하는 중 문제가 발생했습니다. 다시 시도해 주세요.',
  },
  SERVER: {
  ...
  VALIDATION: {
    ...
    MISMATCH: {
      ...
      CLIENT_SECRET:
        '등록된 client_secret와 요청된 client_secret가 일치하지 않습니다.',
      REDIRECT_URI:
        '등록된 redirect_uri와 요청된 redirect_uri가 일치하지 않습니다.',
      ADDRESS_URI:
        '등록된 address_uri와 요청된 address_uri가 일치하지 않습니다.',
    ...
    FORMAT: {
      ...
      AUTHENTICATION:
        '잘못된 형식의 클라이언트 인증 정보입니다. "Basic" 형식을 사용해야 합니다.',
    },
    UNSUPPORTED: {
      RESPONSE_TYPE: 'response_type은 code만 지원됩니다.',
      GRANT_TYPE:
        'grant_type은 authorization_code 또는 refresh_token만 지원됩니다.',
    },
    EXPIRED: {
